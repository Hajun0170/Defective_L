...
public class InteractionDirector : MonoBehaviour //대사 출력 코드인데 일부 조정해서 쓰진 않음
{
    [Header("설정")]
    ...
    // CutsceneDirector와 똑같은 구조체 사용
    [System.Serializable]
    public struct ActorMapping
    {
        public string csvName;           // CSV 이름 
        public Transform targetObj;      // 말풍선 띄울 위치 Point
    ...
    private IEnumerator PlaySequence()
    {
        ...
        // 대사 순차 재생 CutsceneDirector와 동일한 로직
